...
if __name__ == '__main__':
    ...
    mypath = args.path #'wresnet28x10_cifar100_4xb64_valsteps_maxlr.1_learnedrandprepreprocessorensemble_optwidelongsesp_50epochs_2_.0ent_no0augs_.001mlr_exploresm'
    suffix = '.yaml'
    ...
    paths = [join(join(logdir,path),'test') for path in paths]
    results = [get_last_top1(path) for path in paths]
