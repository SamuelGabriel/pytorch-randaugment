...
## Copied from backpack.core.derivatives.conv2d, changed line where marked
...
class Conv2DDerivatives(BaseParameterDerivatives):
    ...
    def _weight_jac_t_mat_prod(self, module, g_inp, g_out, mat, sum_batch=True):
        ...
        N_axis = 0
        input = eingroup("n,c,h,w->nc,h,w", g_inp).unsqueeze(N_axis) # CHANGE: use g_inp instead of module.input0
